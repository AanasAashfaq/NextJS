...
function RedirectToGitHub() {
  ...
  return (
    ...
    break-words rounded-2xl border-2 shadow-lg m-auto border-solid bg-white bg-clip-border mb-4">
...
<div className=" w-[100%]  flex justify-center h-[600px] m-auto py-4 pr-1 mb-4 ">
    <div className="w-[100%] min-h-[100%]  ">
      ...
      <Link  href='https://github.com/Muhammad1umer-tech/Python-project' legacyBehavior><a className='text-blue-500 m-auto text-3xl underline underline-offset-1'>Kaggle</a></Link>
        </div>
    </div>
</div>
</div>
